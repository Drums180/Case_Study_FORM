...
```{r}
df= read_xlsx("/Users/ale/Downloads/BDD_FORM_BAJAS_2023.xlsx")
head(df)
```
...
1. Sostenibilidad e Innovación: Utilizar la experiencia y el compromiso de la empresa con la sostenibilidad para poder liderar en la industria y en el mercado con empaques renovables y ecológicos para seguir creciendo ante la demanda. También, en las gráficas se observa bajas por género con un predominio en bajas femeninas en los departamentos. Esto nos indica que podrían mejorar las políticas de diversidad e inclusión ya que se promueve un ambiente de trabajo inclusivo. Con esto, además de mejorar su imagen siendo líder en sostenibilidad social, también aprovechan una diversidad de perspectivas para impulsar la innovación.

2. Expansión en Servicios Personalizados: Desarrollar soluciones personalizadas a los clientes y mejorar su relación con marcas de prestigio. Así como la empresa ha trabajado con Tesla, se busca su crecimiento con empresas internacionales.


##Debilidades-Oportunidades (DO)
1. Mitigar dependencias en el mercado: Ampliar el mercado hacia nuevas industrias, para reducir la dependencia del sector automotriz, creciendo a nuevos mercados con demanda creciente a soluciones innovadoras. Las gráficas observan bajas mensuales y esto nos indica la necesidad de estabilizar la fuerza laboral a través de la expansión a nuevos mercados. Esto podría ayudar a estabilizar la empresa frente a fluctuaciones estacionales y específicas del sector automotriz.

2. Colaboraciones con Innovación: Realizar colaboraciones estratégicas para dividir el costo de riesgo de innovación y desarrollo, dándole a la empresa un gran alcance para ser el líder en la industria.


##Fortalezas-Amenazas (FA)
1. Liderazgo ante Cambios regulatorios: Emplear compromiso con la innovación y sostenibilidad para que la empresa se adapte ante los cambios en regulaciones ecológicas, posicionando a FORM como un referente en cumplimiento y adaptabilidad. También, en base a las gráficas en antecedentes, se pueden implementar tendencias de bajas a lo largo del tiempo con picos específicos, debido a que la capacidad de adaptación de los picos requieren más flexibilidad en la gestión de recursos humanos.

2. Valor agregado frente a la Competencia: Fortalecer a la empresa a través de su confiabilidad con sus clientes, aprovechando su calidad para destacarse en el mercado competitivo, así mismo aprovechando sus colaboraciones con marcas de alto prestigio.

##Debilidades-Amenazas (DA)
1. Cobertura de riesgo en Costos: Realizar estrategias para tomar medidas de prevención para protegerse contra la volatilidad de los precios de los materiales, como lo es la diversificación de los proveedores y los contratos de la empresa a largo plazo.

2. Programas de Lealtad con Clientes: Implementar programas de colaboración y lealtad con los clientes actuales, para poder mejorar la relación a largo plazo y mitigar el impacto de la competencia y las fluctuaciones del mercado. En los antecedentes de la empresa podemos observar que existe una alta rotación en ciertos departamentos (especialmente en producción de cartón). Aunque esta estrategia se enfoca en clientes, puede adaptarse internamente para mejorar la retención de empleados. Esto reforzaría la lealtad y mejoraría la satisfacción laboral, esto reduce la rotación del personal, y aumenta la eficiencia en la producción.
